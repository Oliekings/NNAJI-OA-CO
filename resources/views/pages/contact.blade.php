...
@section('content')
    ...
    <div class="py-20 bg-ivory-base">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-20">
            ...
            <!-- 4 Branches (Kaduna Head Office First) -->
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
                @foreach([
                    ['icon' => 'fa-landmark', 'label' => 'Corporate Head Office', 'title' => 'Kaduna Head Office', 'address' => 'Plot No. 7 Yunus Ustaz Usman Road (formerly Zaki Road) Abakpa G.R.A., P.O. Box 1607, Kaduna.', 'phone' => '0805 139 7435, 08037002395', 'person' => 'ESV Alh. Salisu M. Yahaya Pai', 'featured' => true],
                    ['icon' => 'fa-building', 'label' => 'Practice & Regional Desk', 'title' => 'Abuja Regional Office', 'address' => 'Block 07, Drive 1, Prince and Princess Estate, Abuja, FCT.', 'phone' => '08037002395, 08187666130', 'person' => 'ESV Nnaji Nnamdi Ikechukwu (FNIVS)', 'featured' => false],
                    ...
                    ['icon' => 'fa-globe', 'label' => 'North America Desk', 'title' => 'USA Representative Desk', 'address' => '15650 Fenkell Str. Apt. 210, Detroit, MI 48227, United States of America.', 'phone' => '+1 313-651-6685', 'person' => 'Mrs. Chidi Nnaji (MBA)', 'featured' => false],
                ] as $i => $branch)
